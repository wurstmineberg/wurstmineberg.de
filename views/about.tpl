        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    ...
                    <p><a href="http://wiki.wurstmineberg.de/Creative">Creative server</a> adress: <code>creative.wurstmineberg.de</code></p>
                    <p>In case of <a href="http://wiki.wurstmineberg.de/Ultra_Softcore">USC</a>: <code>usc.wurstmineberg.de</code><p>
                </div>
            </div>
            ...
            <ul>
                ...
                <li>We're pretty much end-game, as far as <a href="/stats#achievements">the achievement progress</a> is concerned. The dragon has been dead for ages and the <a href="http://wiki.wurstmineberg.de/Category:End">End</a> has been turned into <a href="http://wiki.wurstmineberg.de/Ender_ender_2.0">an XP farm</a>. The lunchbox which will be part of your <a href="http://wiki.wurstmineberg.de/Tour">server tour</a> has things like an Ender chest in it. We also have beacons pretty much everywhere. If you want to start from scratch, expect to be playing singleplayer style for a while.</li>
            </ul>
            <p>Now for the actual invitation process, read <a href="http://wiki.wurstmineberg.de/Invitations">this wiki page</a>. See <a href="/">the main page</a> for ways to contact us.</p>
            <h2 id="starter">Getting started</h2>
            <p>If you're new and don't know where to go and what to do, chances are you didn't get a <a href="http://wiki.wurstmineberg.de/Tour">server tour</a> by one of our more senior members. Sorry about that. The first thing you'll see is our <a href="http://wiki.wurstmineberg.de/Category:Spawn">spawn area</a>, which is rather obviously still being built, like so many things on the server. “Beneath” the spawn area is our <a href="http://wiki.wurstmineberg.de/Newther_Hub">Nether hub</a>, which serves as a central community trafficing area and connects various tunnels to other peoples's nether portals. Both the Nether hub and spawn area are community oriented builds. All the supplies there are either donated or specifically collected for specific builds or purposes, so… well, the general rule is “Don't be a dick”. If something has a sign with “free to take” on it, you can probably take it. Taking <em>everything</em> is generally frowned upon for reasons of obviousness. Also, even if there are usually some community supplies floating around (like steak), please don't rely on them as your only means of, you know, not starving to death.</p>
            <p>If you'd like to work on community builds like spawners, <a href="http://wiki.wurstmineberg.de/Category:Farms">farms</a> or whatever, please try to ask around some of the other people who may or may not have already started preparations for such builds. It's not about <em>owning</em> a community project, it's just about coordination and not stepping on people's toes. However, experience shows that you probably won't be murdered in your sleep if you build at spawn without discussing every minor detail with everyone. Hanging around on the <a href="irc://chat.freenode.net/#wurstmineberg">IRC channel</a> and/or checking out the <a href="https://twitter.com/wurstmineberg">Twitter account</a> and/or checking out the <a href="http://wiki.wurstmineberg.de/">wiki</a> should give a start as to what's currently going on. And sometimes it doesn't.</p>
            ...
            <div class="funding-progress-container-about">
                	<p class="funding-text-container">Funding<span class="funding-text"> <span class="funding-for">for </span><span class="funding-month">(loading)</span><span class="funding-month-small">(loading)</span></span>:</p>
                	<div class="funding-progressbar progress progress-striped active">
