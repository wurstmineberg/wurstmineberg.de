        ...
        <div class="container">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <p class="lead">Wurstmineberg is a whitelisted multi world <a href="http://www.minecraft.net/">Minecraft</a> server. We run several worlds on a dedicated root server.</p>
                    <p>The main world usually runs the latest version of Minecraft, including the latest <a href="http://minecraft.gamepedia.com/Version_history/Development_versions">snapshots</a> if they're not too broken. Therefore we can't run any serverside mods there, sorry. But we do have some awesome selfmade tools that really replace lots of that functionality. We also have a <a href="http://wiki.{{host}}/Mod">modded server</a> if you like mods.</p>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>We set up <a href="http://mapcrafter.org/">Mapcrafter</a> to generate a daily overview map of our main world. It runs a lot faster than <a href="http://overviewer.org/">Minecraft Overviewer</a> (which we used before Mapcrafter), but it's still kind of experimental.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>We have <a href="http://www.mediawiki.org/">MediaWiki</a> to harvest the glorious benefits of wiki-technology for our purposes.</p>
                    ...
                    <p>There are also articles about <a href="http://wiki.{{host}}/Category:Fictional">fictional content</a>. Fun stuff.
