...
wsl -d ubuntu-m2 rsync --mkpath --delete -av /mnt/f/git-stages/github.com/wurstmineberg/wurstmineberg.de/ /home/fenhl/wslgit/github.com/wurstmineberg/wurstmineberg.de/ --exclude target
if (-not $?)
{
    throw 'Native Failure'
}
...
wsl -d ubuntu-m2 mkdir -p /mnt/f/git-stages/github.com/wurstmineberg/wurstmineberg.de/target/wsl/release
if (-not $?)
{
    throw 'Native Failure'
}

wsl -d ubuntu-m2 cp /home/fenhl/wslgit/github.com/wurstmineberg/wurstmineberg.de/target/x86_64-unknown-linux-musl/release/wurstmineberg-web /mnt/f/git-stages/github.com/wurstmineberg/wurstmineberg.de/target/wsl/release/wurstmineberg-web
if (-not $?)
{
    throw 'Native Failure'
}
...
ssh wurstmineberg.de sudo systemctl reload caddy nginx uwsgi
if (-not $?)
{
    throw 'Native Failure'
}
